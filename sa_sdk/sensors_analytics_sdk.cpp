...
bool Sdk::AddEvent(const string &action_type,
  ...
  record_node.SetString("time", std::to_string(current_timestamp));
  record_node.SetString("send_time", std::to_string(current_timestamp));
  record_node.SetString("anonymous_id", distinct_id);
