#ifndef DURATIONTABLEMODEL_H
#define DURATIONTABLEMODEL_H
...
// 使用时长记录
class DurationTableModel : public QAbstractTableModel, public QQmlParserStatus
{
    Q_OBJECT
...
public:
    explicit DurationTableModel(QObject *parent = nullptr);
    static DurationTableModel* m_pdurationTableModel;
