...
//订单记录列表
class RedeemTableModel : public QAbstractTableModel, public QQmlParserStatus
{
    Q_OBJECT
...
public:
    explicit RedeemTableModel(QObject *parent = nullptr);
    static RedeemTableModel* m_predeemTableModel;
